...
<head>
   ...
   #ft p{text-align: left;padding:1em 0;color: #ccc;font-size: 14px;text-indent: 1em;}
   #ft p a{color: #fff}
   </style>
</head>
<body>
<div id="doc" class="yui-t7">
   ...
   <div id="ft" role="contentinfo"><p>follow me @<a href="http://twitter.com/thinkphp">thinkphp</a> | <a href="index.phps">index.phps </a >| download on <a href="https://github.com/thinkphp/slideshare">Github</a></p></div>
</div><!-- end doc -->
